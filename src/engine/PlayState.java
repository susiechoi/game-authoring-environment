...
public class PlayState implements GameData {
	...
	myMediator.updateLevel(currentLevel.myNumber());
	myMediator.setPath(currentLevel.getLevelPathMap(), currentLevel.getBackGroundImage(), currentLevel.getPathSize(), currentLevel.getGridWidth(), currentLevel.getGridHeight(), currentLevel.getTransparent());
    }
