...
public class EnemyBuilder {
	...
	Enemy newEnemy = new Enemy(name, image, speed, 50, new Launcher(null, null), new HealthProperty(0, 0, initialHealth), new DamageProperty(0 , 0 , healthImpact), new ValueProperty(killReward));
	return newEnemy;
    }
